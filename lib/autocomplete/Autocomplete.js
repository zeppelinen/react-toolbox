    ...
    function Autocomplete() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Autocomplete.__proto__ || Object.getPrototypeOf(Autocomplete)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        _this.setState({
          active: '',
          focus: true,
          direction: _this.calculateDirection(_this.props.direction)
        });
    ...
    _createClass(Autocomplete, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            theme = _props.theme,
            other = _objectWithoutProperties(_props, ['allowCreate', 'error', 'keepFocusOnChange', 'label', 'onQueryChange', 'selectedPosition', 'showSelectedWhenNotInSource', 'showSuggestionsWhenValueIsSet', 'source', 'suggestionMatch', 'theme']);
