...
var getRenderedClassName = function getRenderedClassName(tree, TargetComponent) {
  var rendered = _testUtils2.default.findRenderedComponentWithType(tree, TargetComponent);
...
describe('Tabs', function () {
  ...
  it('defaults to only rendering the current tab', function () {
    ...
    tabContents = _testUtils2.default.scryRenderedComponentsWithType(composition, _TabContent2.default);
  ...
  describe('#render', function () {
    it('does not use fixed by default', function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Tabs2.default, { theme: _theme2.default }));
    ...
    it('uses fixed when set', function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Tabs2.default, { theme: _theme2.default, fixed: true }));
      var className = getRenderedClassName(tree, _Tabs.Tabs);
    ...
    it('uses inverse when set', function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Tabs2.default, { theme: _theme2.default, inverse: true }));
      var className = getRenderedClassName(tree, _Tabs.Tabs);
