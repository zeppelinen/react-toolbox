...
var Tab = function (_Component) {
  ...
  function Tab() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Tab.__proto__ || Object.getPrototypeOf(Tab)).call.apply(_ref, [this].concat(args))), _this), _this.handleHrefClick = function (event) {
      if (event.metaKey) {
        return;
      }
  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          theme = _props.theme,
          href = _props.href,
          other = _objectWithoutProperties(_props, ['onActive', 'active', 'activeClassName', 'className', 'disabled', 'hidden', 'label', 'icon', 'theme', 'href']);
      ...
      if (href) {
        return _react2.default.createElement(
          'a',
          _extends({ href: href, rel: 'nofollow' }, other, { 'data-react-toolbox': 'tab', className: _className, onClick: this.handleHrefClick }),
      ...
      return _react2.default.createElement(
        'button',
        _extends({ type: 'button' }, other, { 'data-react-toolbox': 'tab', className: _className, onClick: this.handleClick }),
        icon && _react2.default.createElement(_font_icon.FontIcon, { className: theme.icon, value: icon }),
        label
      );
    }
