...
describe('ProgressBar', function () {
  ...
  describe('#calculateRatio', function () {
    before(function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_ProgressBar2.default, { min: 100, max: 300, theme: _theme2.default }));
      progressBar = _testUtils2.default.findRenderedComponentWithType(tree, _ProgressBar.ProgressBar);
    });
