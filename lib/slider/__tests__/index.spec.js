...
describe('Slider', function () {
  ...
  describe('#positionToValue', function () {
    before(function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Slider2.default, { min: -500, max: 500 }));
      slider = _testUtils2.default.findRenderedComponentWithType(tree, _Slider.Slider);
  ...
  describe('#trimValue', function () {
    before(function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Slider2.default, { min: 0, max: 100, step: 0.1 }));
      slider = _testUtils2.default.findRenderedComponentWithType(tree, _Slider.Slider);
    });
  ...
  describe('#valueForInput', function () {
    before(function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Slider2.default, { min: 0, max: 100, step: 0.01 }));
      slider = _testUtils2.default.findRenderedComponentWithType(tree, _Slider.Slider);
    });
  ...
  describe('#knobOffset', function () {
    it('returns the corresponding offset for a given value and slider length/start', function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Slider2.default, { min: -500, max: 500, value: -250 }));
      slider = _testUtils2.default.findRenderedComponentWithType(tree, _Slider.Slider);
      slider.setState({ sliderStart: 500, sliderLength: 100 });
  ...
  describe('#render', function () {
    it('contains a linear progress bar with proper properties', function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Slider2.default, { min: 100, max: 1000, value: 140 }));
      slider = _testUtils2.default.findRenderedComponentWithType(tree, _Slider.Slider);
      progress = _testUtils2.default.findRenderedComponentWithType(slider, _ProgressBar.ProgressBar);
    ...
    it('contains an input component if its editable', function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Slider2.default, { editable: true, value: 130 }));
      slider = _testUtils2.default.findRenderedComponentWithType(tree, _Slider.Slider);
      input = _testUtils2.default.findRenderedComponentWithType(slider, _Input2.default);
  ...
  describe('#events', function () {
    beforeEach(function () {
      ...
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Slider2.default, { min: -500, max: 500, onChange: onChange }));
      slider = _testUtils2.default.findRenderedComponentWithType(tree, _Slider.Slider);
    ...
    it('sets pressed state when knob is clicked', function () {
      _testUtils2.default.Simulate.mouseDown(slider.refs.knob);
      (0, _expect2.default)(slider.state.pressed).toEqual(true);
    });

    it('sets pressed state when knob is touched', function () {
      _testUtils2.default.Simulate.touchStart(slider.refs.knob, { touches: [{ pageX: 200 }] });
      (0, _expect2.default)(slider.state.pressed).toEqual(true);
    });

    it('sets a proper value when the slider is clicked', function () {
      _testUtils2.default.Simulate.mouseDown(slider.refs.slider, { pageX: 200 });
    ...
    it('sets a proper value when the slider is touched', function () {
      _testUtils2.default.Simulate.touchStart(slider.refs.slider, { touches: [{ pageX: 200, pageY: 0 }] });
      (0, _expect2.default)(onChange.called).toEqual(true);
      (0, _expect2.default)(onChange.getCall(0).args[0]).toEqual(-300);
    });

    it('changes input value when slider changes', function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Slider2.default, { editable: true, onChange: onChange }));
      slider = _testUtils2.default.findRenderedComponentWithType(tree, _Slider.Slider);
      slider.setState({ sliderStart: 0, sliderLength: 1000 });
      slider.handleResize = function (event, callback) {
        callback();
      ...
      input = _testUtils2.default.findRenderedComponentWithType(slider, _Input2.default);
      _testUtils2.default.Simulate.mouseDown(slider.refs.slider, { pageX: 900 });
      (0, _expect2.default)(onChange.called).toEqual(true);
      (0, _expect2.default)(onChange.getCall(0).args[0]).toEqual(90);
    });

    it('changes its value when input is blurred', function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Slider2.default, { editable: true, value: 50, onChange: onChange }));
      slider = _testUtils2.default.findRenderedComponentWithType(tree, _Slider.Slider);
      input = _testUtils2.default.findRenderedComponentWithType(slider, _Input.Input);
      _testUtils2.default.Simulate.change(input.refs.input, { target: { value: '80' } });
      _testUtils2.default.Simulate.blur(input.refs.input);
      (0, _expect2.default)(onChange.called).toEqual(true);
    ...
    it('calls onChange callback when the value is changed', function () {
      ...
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Slider2.default, { onChange: onChangeSpy }));
      slider = _testUtils2.default.findRenderedComponentWithType(tree, _Slider.Slider);
      slider.setState({ sliderStart: 0, sliderLength: 1000 });
      _testUtils2.default.Simulate.mouseDown(slider.refs.slider, { pageX: 900 });
