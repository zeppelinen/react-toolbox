...
var getRenderedClassName = function getRenderedClassName(tree, Component) {
  var rendered = _testUtils2.default.findRenderedComponentWithType(tree, Component);
...
describe('Button', function () {
  describe('#render', function () {
    it('uses flat and neutral styles by default', function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Button2.default, { theme: _theme2.default }));
    ...
    it('renders accent button with accent style', function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Button2.default, { accent: true, theme: _theme2.default }));
      var className = getRenderedClassName(tree, _Button.Button);
      (0, _expect2.default)(className).toContain(_theme2.default.flat);
    ...
    it('renders mini button with mini style', function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Button2.default, { floating: true, mini: true, theme: _theme2.default }));
      var className = getRenderedClassName(tree, _Button.Button);
    ...
    it('renders mini accented button with both styles', function () {
      var tree = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_Button2.default, { accent: true, mini: true, theme: _theme2.default }));
      var className = getRenderedClassName(tree, _Button.Button);
      (0, _expect2.default)(className).toContain(_theme2.default.flat);
      (0, _expect2.default)(className).toContain(_theme2.default.accent);
      (0, _expect2.default)(className).toContain(_theme2.default.mini);
